# Spec: merge-order-orchestration — Functional Requirements
...
This spec describes the observable behaviour that MUST be true after the merge-order orchestration
platform component is fully implemented. It does NOT prescribe implementation or package structure;
that is the design phase's responsibility.
